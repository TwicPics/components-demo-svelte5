    ...
    <TwicAbstract title="Short Videos">
      ...
      <p>
        The TwicPics API features three transformations that can be used to <a
          href="https://www.twicpics.com/docs/topics/video-optimization#video-slicing?utm_source=github&utm_medium=organic&utm_campaign=components#svelte3"
          target="_blank"
      ...
      <ul>
        ...
        <li>
          <Code>preTransform</Code>:<span
            >allows to perfom <a
              href="https://www.twicpics.com/docs/reference/transformations?utm_source=github&utm_medium=organic&utm_campaign=components#svelte3"
              target="_blank"
